...
class BritishAmericanCF(PaperCounterfactualGenerator):
    """
    This class generates counterfactuals by converting british to american english and vice versa.
    ...
    def __init__(self, llm: ChatLLM, prompt_base_path: Path | str = None, conversion_ratio=0.4):
        super().__init__(name=f"british_american_{conversion_ratio:.2f}")
    ...
    def use_conversion_prompt(self):
        self.llm.load_prompt(self.prompt_base_path / "manual/style_change/american_british_conversion.txt")
