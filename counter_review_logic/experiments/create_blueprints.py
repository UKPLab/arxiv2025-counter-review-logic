...
from .utils import load_llm, set_all_seeds, get_data_by_share
from ..framework import PaperArchitect
...
def main():
    parser = argparse.ArgumentParser(description="Create blueprints of the given paper splits and venues")
    ...
    parser.add_argument('--model_type', type=str, required=False,
                        help='Type of the model to use for blueprint generation')
