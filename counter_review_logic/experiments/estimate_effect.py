...
from .utils import set_all_seeds, get_data_by_share, load_rde
...
def main():
    parser = argparse.ArgumentParser(description="Estimate the differences numerically between reviews based on the detected deltas.")
