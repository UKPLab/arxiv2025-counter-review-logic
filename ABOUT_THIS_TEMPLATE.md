...
- 🎯 Entry points to execute your program using `python -m <counter_review_logic>` with basic CLI argument parsing;
- 🔄 Continuous integration using [Github Actions](https://github.com/UKPLab/counter-review-logic/actions) with jobs to check, lint and test your project;
...
│
├───counter_review_logic             # The main python package for the project
...
You should create new files and subpackages inside counter_review_logic and implement your functionalities there. Remember to add what you write to `__init__.py` so that the imports work smoothly. Take a look at `base.py` and `__init__.py` to understand how it works.
...
It contains [GitHub Actions](https://docs.github.com/en/actions) that are executed automatically when pushing your code. You can see results for your repository [here](https://github.com/UKPLab/counter-review-logic/actions).
